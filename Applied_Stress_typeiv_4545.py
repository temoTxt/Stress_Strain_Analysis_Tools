...
'''calculate the applied stress for type iv d638 specimens at 4545 raster for 4 build configurations'''
for n in range(0, 4):
    percent_uts = [.95, .85, .75, .65]
    #typeiv_uts = [33.3, 33.2, 28.3, 28.5]
    applied_stress1 = round(33.3 * percent_uts[n], 1)
    print(applied_stress1)
    applied_stress2 = round(33.2 * percent_uts[n], 1)
    print(applied_stress2)
    applied_stress3 = round(28.3 * percent_uts[n], 1)
    print(applied_stress3)
    applied_stress4 = round(28.5 * percent_uts[n], 1)
...
print(AppliedStress)
typeiappliedstress_data = open('data/appliedstress_typeiv_4545', 'r+')
